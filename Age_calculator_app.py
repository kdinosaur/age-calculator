...
#add intro text
alabel = tk.Label(text="Enter birthdate below")
...
def calculate_age():
    ...
    print(day_entry.get())
    person = Person('This Person', datetime.date(int(year_entry.get()),
                                          int(month_entry.get()),
                                          int(day_entry.get())))
    print(person.age())
...
# ThisPerson = Person('This person', datetime.date(1940, 8, 20))
# print(ThisPerson.name)
# print(ThisPerson.birthdate)
# print(ThisPerson.age())
